...
/*autores: - Ariel Undurraga - Marcela Rivera
En este laboratorio se busca realizar un programa  que permita crear procesos, ademàs se permite la comunicaciòn entre procesos, 
esto ocurre con señales.*/
